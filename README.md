...
### 💬 Projects
- 🎮 [***Have some fun playing tic tac toe with a friend!](https://hatruong05.github.io/JS-Tic-Tac-Toe/). [GitHub repo](https://github.com/HaTruong05/JS-Tic-Tac-Toe). *Features a sleek, modern UI in a dark theme.*
